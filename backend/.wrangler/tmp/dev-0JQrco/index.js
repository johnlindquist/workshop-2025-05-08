...
// .wrangler/tmp/bundle-R9zusg/checked-fetch.js
      ...
      this.html = (html, arg, headers) => {
        ...
        if (typeof html === "object") {
          ...
          if (html instanceof Promise) {
            return html
              .then((html2) =>
                resolveCallback(html2, HtmlEscapedCallbackPhase.Stringify, false, {}),
              )
              .then((html2) => {
                return typeof arg === "number"
...
// .wrangler/tmp/bundle-R9zusg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-R9zusg/middleware-loader.entry.ts
